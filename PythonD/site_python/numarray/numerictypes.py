...
$Id: numerictypes.py,v 1.52 2005/10/20 21:01:23 jaytmiller Exp $
"""
...
class NumericType(_numerictype):
    """Numeric type class
    ...
    def __init__(self, name, bytes, default, typeno):
        _numerictype.__init__(self, name, bytes, default, typeno)
        try:
...
_register("bool", Bool)
_register("int8", Int8)
_register("uint8", UInt8)
_register("int16", Int16)
_register("uint16", UInt16)
_register("int32", Int32)
_register("uint32", UInt32)
_register("int64", Int64)
_register("uint64", UInt64)

_register("float64", Float64)
_register("float32", Float32)
_register("complex128", Complex64)
_register("complex64", Complex32)
